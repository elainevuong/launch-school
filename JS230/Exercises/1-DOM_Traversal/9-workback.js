...
<html>
  ...
  <body><header>Header</header>
    ...
    </main><footer><span class="emphasis"></span></footer></body>
</html>
*/
...
console.log(document.querySelector('body')
                    .replaceChild(document.querySelector('footer'), 
                                  document.body.firstElementChild).tagName); // 'HEADER' 
...
console.log(document.querySelector('section').children); // returns HTMLCollection(3) [h1, p, p]
