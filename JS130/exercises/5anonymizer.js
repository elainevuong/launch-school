...
// The key part of this solution is the use of an IIFE to create a private scope 
// that is only accessible to the object returned when executing Object.create(Account).