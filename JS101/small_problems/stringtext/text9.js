...
Input - 1) 'search' term
        2) a corpus of text
Output - an integer, that represents the number of times the word appears in the text
*/

function searchWord(query, corpus) {
  return corpus.split(' ')
        .filter((word) => word.toLowerCase() === query.toLowerCase())
        .length;
